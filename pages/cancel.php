...
//     foreach ($errors as $e) {
//         echo "<div style='color:red; font-weight: bold;'>$e</div><br>";
//     }
//     exit;
...
// echo "<br>Slot ID = $slot_id";
// echo "<br>Record = $record";
// echo "<br>Event ID = $event_id";
// echo "<br>Repeat Instance = $repeat_instance";
// echo "<br>Reserved TS = $reserved_ts";

// echo "<br>Cancel URL: <br/>";
