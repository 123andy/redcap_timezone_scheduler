...
## Disclaimer ##
There are a lot of potential configurations, so it can be a little overwhelming at first.  However, if you look at the examples provided, it can be configured with minimal complexity.
...
- which Slot Database are you using?  You will need to know the project_id and have access to the slot database.
